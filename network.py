...
class Network:
    ...
    def run(self):
        ...
        # if router, runRouter; if client, runClient
    ...
    def addLinks(self):
        ...
        # After we parse the links and put them into links dictionary
        # we can loop through these links and addLinks
        # remember that the key of links are addr1 and addr2 pair!!!
