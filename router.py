...
class Router:
    ...
    def changeLink(self, change):
        """Add, remove, or change the cost of a link.
           ...
           'add', or 'remove' """
        # put the changes into linkChanges queue
    ...
    def runRouter(self):
        ...
        while True:
            ...
            try:
                ...
                #if queue is empty, it means that there is no change
                pass
            
            # loop through all the ports, if any port receive a packet, handle it!
    ...
    # All these methods below need to be override
